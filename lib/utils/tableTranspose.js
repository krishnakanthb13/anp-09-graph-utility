import { cleanHeaderName, splitTableRow, isDelimiterOrPlaceholderRow } from "./markdownParser.js";
...
export function transposeStructuredTable(table) {
  ...
  return {
    ...
    index: table.index || 1,
    sourceIndex: table.sourceIndex !== undefined ? table.sourceIndex : table.index,
    sourceRawTableMarkdown: table.sourceRawTableMarkdown || table.rawTableMarkdown,
