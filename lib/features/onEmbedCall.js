  ...
  try {
    switch (actionName) {
      ...
      case "saveImageToNote": {
        ...
        // 1. Attach media to get a permanent Amplenote CDN image URL
        ...
        // 2. Fetch fresh note content immediately before replacing (prevent lost updates)
        ...
        // 3. Locate the target table in fresh note content
