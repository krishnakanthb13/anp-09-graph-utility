        ...
        <div id="formulaRightSection" style="display: none;">
          ...
          <div class="form-group">
            ...
            <select id="formulaPresetSelect" class="select">
              ...
              <option value="sin(x)">🌊 Sine Wave: sin(x)</option>
              <option value="exp(-0.2*x)*sin(2*x)">📉 Damped Sine: exp(-0.2*x)*sin(2*x)</option>
              <option value="x^2 - 4">📈 Quadratic: x^2 - 4</option>
              <option value="0.1*x^3 - x">〰️ Cubic: 0.1*x^3 - x</option>
              <option value="exp(-x^2 / 2)">🔔 Gaussian (Bell): exp(-x^2 / 2)</option>
              <option value="1 / (1 + exp(-x))">⚡ Sigmoid: 1 / (1 + exp(-x))</option>
              <option value="sin(x) + 0.5*sin(3*x)">🎵 Harmonics: sin(x) + 0.5*sin(3*x)</option>
              <option value="abs(x) - 2">📐 Absolute: abs(x) - 2</option>
              <option value="sin(x) / x">💫 Sinc: sin(x) / x</option>
              <option value="sqrt(abs(x))">🌱 Square Root: sqrt(abs(x))</option>
            </select>
          </div>
