 ...
 * Uses high-contrast robust CSS with direct fallbacks, crash-proof payload deserialization,
 * dynamic theme switching, multi-series support, and state persistence.
 *
 * @param {Object} params
 ...
 * @param {Array<Object>} [params.structuredTables] - Parsed structured table objects
 * @param {string} params.noteName - Name of the source note
 * @param {Array<string>} [params.noteTags] - Tags of the source note
 * @param {string} params.noteUUID - UUID of the source note
 * @param {Object} [params.savedState] - Persisted workbench state
...
export function buildChartHtml({
  ...
  // Safe serialized payload via URI encoding
  const payloadObj = {
    noteUUID: noteUUID || '',
  ...
  // Self-contained SVG Favicon data URI for standalone HTML downloads
