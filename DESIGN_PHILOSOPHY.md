...
- **Visual Layering & Stacking Hierarchy**: Data points that need prominence must be easily brought to the foreground. Move Up/Down reordering gives users complete control over chart Z-index layering, bar column grouping sequence, and legend priority.
